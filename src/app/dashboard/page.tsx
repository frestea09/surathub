...
export default function DashboardPage() {
  ...
  const { surat, isLoading, error, fetchAllSurat, updateSurat } =
    useSuratStore();
  ...
  const handleActionClick = (
    surat: Surat,
    action: "detail" | "lacak" | "tolak" | "edit",
  ) => {
    ...
    const cards = [
      {
        ...
        value: data
          .filter((s) =>
            ["Diproses", "Draft", "Baru", "Didisposisikan"].includes(s.status),
          )
          .length.toString(),
      ...
      },
      {
        ...
        value: data
          .filter((s) => {
            ...
            const now = new Date();
            return (
              ["Selesai", "Disetujui", "Terkirim", "Diarsipkan"].includes(
                s.status,
              ) &&
      ...
      cell: ({ row }) => (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem
              onClick={() => handleActionClick(row.original, "lacak")}
            >
              <FileSearch className="mr-2 h-4 w-4" />
              Lacak
            </DropdownMenuItem>
            ...
            <DropdownMenuItem
              ...
              onClick={() => handleActionClick(row.original, "tolak")}
            >
    ...
    <AppLayout>
      <div className="flex items-center justify-between">
        <h1 className="text-lg font-semibold md:text-2xl">
          Dashboard {viewAsUser ? `(${viewAsUser.jabatan})` : ""}
        </h1>
        <div className="w-64">
        ...
        <Card className="xl:col-span-2">
          <CardHeader className="flex flex-row items-center">
            <div className="grid gap-2">
              ...
              <CardDescription>
                Daftar 10 surat terbaru yang diproses{" "}
                {viewAsUser ? `untuk ${viewAsUser.jabatan}` : ""}.
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent>
      ...
      <AlertDialog
        open={isTolakConfirmOpen}
        onOpenChange={setIsTolakConfirmOpen}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Konfirmasi Penolakan Surat</AlertDialogTitle>
            <AlertDialogDescription>
              Apakah Anda yakin ingin menolak surat ini? Status akan diubah
              menjadi &quot;Ditolak&quot;.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
