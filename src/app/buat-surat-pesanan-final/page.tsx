    ...
    <div className="flex min-h-screen w-full flex-col bg-muted/40">
      ...
      <main className="grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:grid-cols-2 lg:grid-cols-3 print:grid-cols-1">
        <div className="grid auto-rows-max items-start gap-4 lg:col-span-1 print:hidden">
          <Card>
            <CardHeader>
              <CardTitle>Detail Surat Pesanan (Vendor)</CardTitle>
              <CardDescription>Isi detail surat yang akan dikirim ke vendor.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <Separator />
               <h3 className="text-sm font-medium">Surat Referensi (Pesanan Internal)</h3>
                <div className="space-y-2">
            ...
            <CardContent>
              <div className="bg-white text-black p-4 sm:p-8 font-serif text-[11pt] print:shadow-none print:p-0" id="surat-preview">
                ...
                <p className="mb-4 text-justify">
                  Berdasarkan Usulan dari Pejabat Pengadaan RSUD Oto Iskandar Di Nata Nomor : {formData.nomorSuratReferensi} Tanggal {formData.tanggalSuratReferensi}, Maka dengan ini kami menyatakan pesanan barang/jasa dengan perincian sebagai berikut:
                </p>
                        ...
                        {items.map((item, index) => {
                            ...
                            return (
                                <TableRow key={item.id}>
                                    ...
                                    <TableCell className="border border-black text-center">{item.diskon > 0 ? `${item.diskon}%` : '0%'}</TableCell>
            ...
            <ScrollArea className="max-h-96">
                <div className="pr-4">
                  {availableSurat.length > 0 ? (
                      ...
                      <p className="text-sm text-muted-foreground text-center p-4">Tidak ada data Surat Pesanan yang tersimpan.</p>
                  )}
                </div>
            </ScrollArea>
        </DialogContent>
