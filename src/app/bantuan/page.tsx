...
const helpContent: Record<string, HelpContent> = {
    ...
    ppk: {
        faq: [
            ...
            { q: "Bagaimana cara mengirim dokumen ke vendor?", a: "Di halaman Surat Keluar, temukan Surat Pesanan (Vendor/Umum) yang sudah jadi. Klik menu aksi (tiga titik) dan pilih 'Kirim / Terbitkan'. Ini akan membuat dokumen dapat diakses oleh vendor melalui portal mereka." },
        ...
        guide: [
            { title: "Memulai Alur Surat Pengadaan (Obat & Umum)", steps: ["Klik 'Buat Surat', lalu pilih jenis pengadaan.", "Pilih '1. Surat Perintah' (untuk Obat) atau '1. Surat Perintah Pengadaan' (untuk Umum).", "Surat ini ditujukan untuk Pejabat Pengadaan (PPBJ) sebagai dasar untuk proses selanjutnya.", "Simpan sebagai draf atau langsung kirim."] },
            { title: "Membuat Surat Pesanan ke Vendor", steps: ["Setelah PPBJ membuat Surat Pesanan Internal (alur obat) atau BA Hasil Pengadaan (alur umum), Anda bisa melanjutkan membuat '3. Surat Pesanan (Vendor)' atau '3. Surat Pesanan (Umum)'.", "Gunakan fitur 'Ambil Data' untuk menarik detail dari surat sebelumnya.", "Lengkapi detail vendor dan informasi lain yang diperlukan, lalu terbitkan."] },
            { title: "Menanggapi Permintaan Revisi", steps: ["Jika vendor meminta revisi, surat akan muncul di tab 'Revisi Diminta' pada halaman Surat Keluar.", "Buka detail surat untuk melihat catatan revisi dari vendor.", "Klik 'Revisi Draf' untuk memperbaiki surat sesuai permintaan, lalu terbitkan kembali."] },
    ...
    ppbj: {
        faq: [
            { q: "Apa tugas utama saya dalam alur pengadaan?", a: "Dalam alur obat, tugas Anda adalah membuat '2. Surat Pesanan (Internal)' setelah menerima '1. Surat Perintah'. Dalam alur umum, tugas Anda adalah membuat '2. BA Hasil Pengadaan' setelah menerima '1. Surat Perintah Pengadaan'." },
